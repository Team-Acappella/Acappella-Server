...
The response MUST be a string that the professor's short answer to the student's question in a professor's tone mentioned below. Answer must be less than 100 characters.
